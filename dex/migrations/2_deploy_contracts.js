...
module.exports = async function (deployer, _network, accounts) {
    ...
    // method use to increment artificially the blockchain block time
    const increaseTime = async (seconds) => {
     ...
     // create some fake past activity in the platform for every token
     ...
     // create some orders that are ready to be filled
     await Promise.all([
